...
def get_train_loader(data_dir, batch_size, num_workers, is_shuffle):
    ...
    train_set = GazeMe(dir_path = data_dir, part = "train", transform = transforms.Compose([transforms.Grayscale(1), transforms.ToTensor()]))
    # create a dataloader
...
if __name__ == '__main__':
    ...
    print(img.shape)
    '''
    train_set, Dataloader = get_train_loader('C:/Users/hasee/Desktop/Master_Project/Step1/Label', batch_size=100, num_workers=1,
                                   is_shuffle=True)
