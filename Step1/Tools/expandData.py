...
def expand(src, dst):
    ...
    # output_dir = 'C:/Users/hasee/Desktop/Master Project/Step1/Expand/300x150'
    ...
    for img in img_list:
        ...
        i += 1
        rotate1 = rotation(src_img, 1)
        output_path = os.path.join(output_dir, "%06d.jpg" % i)
        cv2.imwrite(output_path, rotate1)
        i += 1
        rotate2 = rotation(src_img, -1)
        output_path = os.path.join(output_dir, "%06d.jpg" % i)
        cv2.imwrite(output_path, rotate2)
        i += 1
        flip_img = flipImg(src_img)
        output_path = os.path.join(output_dir, "%06d.jpg" % i)
...
if __name__ == '__main__':
    ...
    dstPath = "C:/Users/hasee/Desktop/Master_Project/Step1/Expand"
